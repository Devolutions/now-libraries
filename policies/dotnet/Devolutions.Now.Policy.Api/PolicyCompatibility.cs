...
public static class PolicyCompatibility
{
    ...
    public static PolicyManagerName ToPolicyModel(this ManagerName value) => value switch
    {
        ...
        ManagerName.Apt => PolicyManagerName.Apt,
        ManagerName.Bun => PolicyManagerName.Bun,
        ManagerName.Cargo => PolicyManagerName.Cargo,
        ManagerName.Chocolatey => PolicyManagerName.Chocolatey,
        ManagerName.Dnf => PolicyManagerName.Dnf,
        ManagerName.Dotnet => PolicyManagerName.Dotnet,
        ManagerName.Flatpak => PolicyManagerName.Flatpak,
        ManagerName.Homebrew => PolicyManagerName.Homebrew,
        ManagerName.Npm => PolicyManagerName.Npm,
        ManagerName.Pacman => PolicyManagerName.Pacman,
        ManagerName.Pip => PolicyManagerName.Pip,
        ManagerName.Scoop => PolicyManagerName.Scoop,
        ManagerName.Snap => PolicyManagerName.Snap,
        ManagerName.Vcpkg => PolicyManagerName.Vcpkg,
        _ => throw new ArgumentOutOfRangeException(nameof(value), value, null),
    };
    ...
    public static ManagerName ToPackageBrokerApi(this PolicyManagerName value) => value switch
    {
        ...
        PolicyManagerName.Apt => ManagerName.Apt,
        PolicyManagerName.Bun => ManagerName.Bun,
        PolicyManagerName.Cargo => ManagerName.Cargo,
        PolicyManagerName.Chocolatey => ManagerName.Chocolatey,
        PolicyManagerName.Dnf => ManagerName.Dnf,
        PolicyManagerName.Dotnet => ManagerName.Dotnet,
        PolicyManagerName.Flatpak => ManagerName.Flatpak,
        PolicyManagerName.Homebrew => ManagerName.Homebrew,
        PolicyManagerName.Npm => ManagerName.Npm,
        PolicyManagerName.Pacman => ManagerName.Pacman,
        PolicyManagerName.Pip => ManagerName.Pip,
        PolicyManagerName.Scoop => ManagerName.Scoop,
        PolicyManagerName.Snap => ManagerName.Snap,
        PolicyManagerName.Vcpkg => ManagerName.Vcpkg,
        _ => throw new ArgumentOutOfRangeException(nameof(value), value, null),
    };
